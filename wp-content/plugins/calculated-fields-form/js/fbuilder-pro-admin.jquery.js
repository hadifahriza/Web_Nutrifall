		...
		$.fbuilder[ 'editForm' ] = function()
			{
				...
				if( 'codeEditor' in wp)
				{
					...
					$('.css-editor-extend-shrink').on('click', function(){$(this).closest('.cff-csseditor-container').toggleClass('fullscreen');});
				}
			};
		...
		$.extend(fform.prototype,
			{
				...
				showAllSettings:function()
				{
					...
					str += '<div><label>Form Template</label><br /><select name="fTemplate" id="fTemplate" class="large">'+template+'</select></div><br /><div style="text-align:center"><span id="fTemplateThumbnail">'+thumbnail+'</span><div></div><span  id="fTemplateDescription">'+description+'</span></div><div class="cff-csseditor-container"><label><div class="css-editor-extend-shrink"></div>Customize Form Design <i>(Enter the CSS rules. <a href="http://cff.dwbooster.com/faq#q82" target="_blank">More information</a>)</i></label><br /><textarea id="fCustomStyles" style="width:100%;height:150px;">'+this.customstyles+'</textarea></div>' ;
